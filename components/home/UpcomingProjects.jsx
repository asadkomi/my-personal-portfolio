...
export default function UpcommingProjects() {
  ...
  const handleModalOpen = (id) => {
    if (id === 1) {
      setTitle("Spring | React");
      setOne("Spring boot / React");
      setTow("Docker");
      setThree("AWS");
      setFour("Slack");
      setFive("Postgres");
      ...
      setTen("Others");
      setImg("/images/upcom.jpg");
      setLink(
        "http://springbootreactsoccerplayer-env.eba-simystxm.us-east-2.elasticbeanstalk.com/"
      );
    } else {
          ...
          <Paper>
            ...
            >
              <CardMedia
                height="250"
                component="img"
                image="/images/upcom.jpg"
                title="Spring / React application"
              ></CardMedia>
              <CardContent>
                <Typography>Spring | React</Typography>
              </CardContent>
            </CardActionArea>
            <CardActions align="center">
              ...
              >
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/asadkomi/shareSoccer"
                  passHref
                >
                  <GitHubIcon />
                </a>
